...
class ArrayMatrixTest extends TestCase
{
    ...
    public function shouldCross_singleItemArrays_multiple_withNames()
    {
        ...
        $expected = [
            ...
            // 2
            //   A
            '["two",0,"r"]' => [2, 'A', 'red'], '["two",0,0]' => [2, 'A', 'green'], '["two",0,1]' => [2, 'A', 'blue'],
            //   B
            '["two",1,"r"]' => [2, 'B', 'red'], '["two",1,0]' => [2, 'B', 'green'], '["two",1,1]' => [2, 'B', 'blue'],
            //   C
            '["two",2,"r"]' => [2, 'C', 'red'], '["two",2,0]' => [2, 'C', 'green'], '["two",2,1]' => [2, 'C', 'blue'],
